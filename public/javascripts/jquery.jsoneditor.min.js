...
(function(){
  ...
  var json2markup = function(json,lvl){
    ...
    if(typeof json == 'object' && json instanceof Array){
      ...
      for(var k in json){
        markup.push('<li class="object-property"><dl class="property-definition"><dt>'+k+':<a href="#" class="property-toggle-button">[-]</a></dt><dd class="property-value">'+json2markup(json[k],lvl)+'</dd></dl></li>')
      };
      if(markup.length == ml){
        // rewind
        markup.shift();
      ...
      markup.push('<span>'+json+'</span>');
    }else if(typeof json === 'number'){
      // handle numbers
      markup.push('<span>'+json.toString()+'</span>');
    }else{ 
